/** * An example leveraging a few Vue features like: * - computed returning
objects * - computed object keys being used within template
(:style="hands.seconds") * - methods starting an interval * - created() calling
an initialization method * - Deriving much state from a single data() value
(data.now) * - Classes as dynamic computed values * - The power of transform()
in CSS */
